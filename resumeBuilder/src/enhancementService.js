...
function cleanJsonResponse(response) {
  ...
  `;
        ...
        return experiences; // Return original on error
      }
    },
  ...
  `;
        ...
        return certifications; // Return original on error
      }
    },
  ...
  `;
        ...
        return achievements; // Return original on error
      }
    },
    ...
    async enhanceResume(formData, jobDescription) {
      ...
      try {
        ...
        const [
          ...
          this.enhanceIntroduction(formData.introduction || '', jobDescription),
          this.enhanceTitle(formData.professionalTitle || '', jobDescription),
          this.enhanceSkills(formData.skills || [], jobDescription),
          this.enhanceProjects(formData.projects || [], jobDescription),
          formData.hasExperience ? 
            this.enhanceExperience(formData.experiences || [], jobDescription) : 
            Promise.resolve([]),
          formData.certifications && formData.certifications.length > 0 ? 
            this.enhanceCertifications(formData.certifications, jobDescription) : 
            Promise.resolve([]),
          formData.achievements && formData.achievements.length > 0 ? 
            this.enhanceAchievements(formData.achievements, jobDescription) : 
            Promise.resolve([]),
          formData.extracurricularActivities && formData.extracurricularActivities.length > 0 ? 
            this.enhanceExtracurricular(formData.extracurricularActivities, jobDescription) : 
            Promise.resolve([])
        ]);
